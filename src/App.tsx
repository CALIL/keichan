...
const downloadXSLX = (rows, fileName): void => {
    ...
    rows.map((row) => {
        ws_data.push([row.id, row.title, row.author, row.publisher, row.pubdate, row.isbn, row.tags ? row.tags.join(',') : '', row.price, row.cCode])
    })
        ...
        <div id="index">
            ...
            <header>
                ...
                <div>
                    ...
                    <a className="github" href="https://github.com/CALIL/keichan" target="_blank">
